...
>
> 2026-09-18 补充：用户授权本项目后续改进与评测所需的真实模型调用，省略费用预估和费用确认步骤，见 [8.5](#85-评测留档与调用约定2026-09-18-更新)。历史失败的离线诊断、连接恢复边界与后续改进顺序见 [8.6](#86-失败诊断与后续改进2026-09-18-待实施)；该补充不表示修复或效果复测已经完成。
>
