...
> 状态：方向已由用户于 2026-09-18 确认，可以实施。本文件取代此前同名文件的全部旧版本（自适应 Agentic RAG、可核验引用、证据账本三版均作废），以及[旧计划](agentic-research-implementation-plan-2026-09-17.md) §8.7 未执行的 S3/S4 与 R5 接续。P0—P8、R1—R4、S1—S2 的代码全部保留。
>
