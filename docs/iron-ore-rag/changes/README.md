...
| 2026-09-05 | 建立固定候选上下文选择回放并比较前缀、统一重排、MMR、覆盖策略与消融；覆盖策略未超过简单基线，按 gate 停止 | 当前 WIP，未提交 | [上下文选择负结果](2026-09-05-context-selection.md) |
| 2026-09-05 | 合并公开开发语料池，接入真实 embedding/PGVector/rerank，记录阶段快照并保留首次超时失败 | 当前 WIP，未提交 | [真实检索阶段诊断](2026-09-05-live-pooled-retrieval.md) |
| 2026-09-05 | 开启隔离 ES BM25/RRF，完成 Hotpot 200 题与完整 SciFact 300 题六臂配对比较；混合检索收益因数据集而异，保留为可选配置 | 当前 WIP，未提交 | [混合检索实测](2026-09-05-hybrid-retrieval-comparison.md) |
