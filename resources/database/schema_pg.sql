...
-- P2 research storage. Existing databases use 260917_02_research_evidence.sql.
-- Fresh initialization uses these definitions directly.

CREATE TABLE t_research_run (
...
COMMENT ON COLUMN t_rag_trace_run.status IS 'RUNNING/SUCCESS/ERROR/CANCELLED';
...
COMMENT ON COLUMN t_rag_trace_node.status IS 'RUNNING/SUCCESS/ERROR/CANCELLED';
