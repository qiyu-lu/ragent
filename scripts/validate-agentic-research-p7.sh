...
cd -- "$p7_repo"
export P3_TESTS=${P7_TESTS:-RequestOperationTest,ModelRoutingExecutorTest,HttpPhaseTraceTest,EmbeddingUsageCaptureTest,BaiLianRerankClientTest,ResearchSourceViewTest,ResearchModelSelectionTest,ResearchEvaluationModelsTest,OneShotResearchRunnerTest,ResearchEventStreamServiceTest,ResearchArtifactGeneratorTest,ResearchRunPostgresIT,ResearchWorkerCoordinatorTest,ResearchWorkerNativeTest,ResearchNativeToolsTest,ResearchResumeTest,ResearchBudgetTest,ResearchRunControllerTest,ResearchEvidenceToolsTest,ResearchEvidenceStoreTest,MultiChannelRetrievalEngineTest,RetrievalScopeResolverTest,VectorSearchChannelTest,KeywordSearchChannelTest,PgVectorRetrieverServiceTest,EsKeywordRetrieverServiceTest,RetrievalEngineTest,StreamChatPipelineTest,IngestionTaskServiceImplTest,TableChunkerTest,WorkbookDiffServiceTest,StreamTaskManagerCancelTraceTest,KnowledgeAccessMatrixPostgresIT,KnowledgeRetrievalIsolationPostgresIT,GraphSearchChannelTest,ChunkEmbeddingServiceCacheTest,EmbeddingCachePostgresIT,ChunkReplaceAtomicityPostgresIT}
